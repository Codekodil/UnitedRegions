...
namespace Tinke
{
    public partial class Sistema : Form
    {
        ...
        public void ReadGame(string file)
        {
        ...
        //    this.Cursor = Cursors.Default;
        //}
        public void Recursivo_UnpackFolder(sFolder currFolder)
        {
            if (currFolder.folders is List<sFolder>)
            {
        ...
        //}
        public void RecursivoExtractFolder(sFolder currFolder, String path)
        {
            if (currFolder.files is List<sFile>)
                foreach (sFile archivo in currFolder.files)
                {
